...
public class Constants {
    ...
    public static final String APP_ID = "9ByzmbowFUfvWQmXgsnaBUdm3zeqjRS3UQktwQQRKMqN";
    public static final String SDK_KEY = "F43weU5ozWRiPk2TJvbw4SfTeDUqjKAsTJ1NAvP7fyCJ";
