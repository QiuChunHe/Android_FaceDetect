...
/**
 * 绘制人脸框帮助类，用于在{@link com.moli.faceDetect.widget.FaceRectView}上绘制矩形
 */
public class DrawHelper {
    ...
    public static void drawFaceRect(Canvas canvas, DrawInfo drawInfo, int faceRectThickness, Paint paint) {
        ...
        if (drawInfo.getName() == null) {
            ...
            paint.setStyle(Paint.Style.FILL_AND_STROKE);
            paint.setTextSize(rect.width() / 8);
            canvas.drawText(drawInfo.getName(), rect.width()/8, rect.top - 40, paint);
//            canvas.drawText(drawInfo.getName(), rect.centerX(), rect.top - 20, paint);
        }
    }
